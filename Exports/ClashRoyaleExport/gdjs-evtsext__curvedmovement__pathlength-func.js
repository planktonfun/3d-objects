...
gdjs.evtsExt__CurvedMovement__PathLength.idToCallbackMap = new Map();


gdjs.evtsExt__CurvedMovement__PathLength.userFunc0x198c4d8 = function GDJSInlineCode(runtimeScene, objects, eventsFunctionContext) {
"use strict";
...
const objects = [];
gdjs.evtsExt__CurvedMovement__PathLength.userFunc0x198c4d8(runtimeScene, objects, eventsFunctionContext);
