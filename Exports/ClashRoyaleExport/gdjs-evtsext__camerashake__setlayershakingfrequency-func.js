...
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.idToCallbackMap = new Map();
...
let isConditionTrue_0 = false;
{
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(6).getChild(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(8).getAsString()).getChild("Frequency").setNumber(eventsFunctionContext.getArgument("Frequency"));
}
}
...
gdjs.evtsExt__CameraShake__SetLayerShakingFrequency.func = function(runtimeScene, Frequency, NewLayerName, parentEventsFunctionContext) {
