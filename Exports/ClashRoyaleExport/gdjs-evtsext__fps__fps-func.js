...
gdjs.evtsExt__FPS__FPS.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.returnValue = gdjs.evtTools.variable.getVariableChildCount(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0)) / (eventsFunctionContext.sceneVariablesForExtension.getFromIndex(1).getAsNumber() / 1000);}
}
