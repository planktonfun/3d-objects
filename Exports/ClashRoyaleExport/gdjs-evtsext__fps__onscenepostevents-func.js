...
gdjs.evtsExt__FPS__onScenePostEvents.idToCallbackMap = new Map();
...
{
{eventsFunctionContext.sceneVariablesForExtension.getFromIndex(1).setNumber(gdjs.evtTools.runtimeScene.getTime(runtimeScene, "timestamp") - eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0).getChild(0).getAsNumber());
}
}
...
let isConditionTrue_0 = false;
if (true) {
{gdjs.evtTools.variable.variableRemoveAt(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0), 0);
}
...
let isConditionTrue_0 = false;
{
{gdjs.evtTools.variable.valuePush(eventsFunctionContext.sceneVariablesForExtension.getFromIndex(0), gdjs.evtTools.runtimeScene.getTime(runtimeScene, "timestamp"));
}
}
